<template>
  <div class="centerDialogBox" v-show="isShowDialog">
    <div
      class="centerDialogMask"
      @click.stop="hideDialog"
      v-bind:class="{
        fadeIn: isShowDialog,
        animated: isShowDialog,
        disabled: !closable,
      }"
    ></div>
    <div
      class="centerDialog"
      v-bind:class="{
        slideInUp: isShowDialog && !sideslip,
        slideInRight: isShowDialog && sideslip,
        animated: isShowDialog,
      }"
    ...
    >
      <div class="title">
        ...
        <!-- <template v-if="sideslip">
          <i
            class="icon iconfont icon-a-20_fanhuianniu"
            @click="hideDialog"
            v-if="closable"
          ></i>
        </template>
        <template v-else>
          <i
            class="icon iconfont icon-a-16_guanbi_ciji"
            @click="hideDialog"
            v-if="closable"
          ></i>
        </template> -->
